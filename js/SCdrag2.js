    ...
    Dragger.prototype = {
        init: function() {
            var spaceX, spaceY,
                opts = this.options,
                $this = this.$element,
                toolStatus = { isActive: false, isDrag: false, isRotate: false, isScale: false, isStretch: false, };
            ...
            // 旋转
            $this.on('mousedown', '.toolrot', function(e) {
                e.stopPropagation();
                toolStatus.pos = getPosition($this);
            ...
            // 缩放
            $this.on('mousedown', '.scale', function(e) {
                e.stopPropagation();
            ...
            // 拉伸
            $this.on('mousedown', '.stretch', function(e) {
                e.stopPropagation();
                console.log('stretch');
            ...
            $(document).mousemove(function(e) {
                ...
                if (opts.restrictIn && (toolStatus.isDrag || toolStatus.isRotate || toolStatus.isScale || toolStatus.isStretch)) {
                    ...
                    if (!((thisPos.vtop >= fatherPos.vtop) && (thisPos.vbottom <= fatherPos.vbottom) && (thisPos.vleft >= fatherPos.vleft) && (thisPos.vright <= fatherPos.vright))) {
